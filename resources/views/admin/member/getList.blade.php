...
<tr>
    ...
    <td class="col-2 text-center border border-dark align-middle">{{ $member->memberName }}</td>
    <td class="col-2 text-center border border-dark align-middle">{{ $member->email }}</td>
    <td class="col-2 text-center border border-dark align-middle">{{ $member->tel }}</td>
